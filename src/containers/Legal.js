...
const TermsOfService = () => (
  <>
    ...
    <Typography variant="body1" gutterBottom>
      ...
      <Link href="/">https://jratana1.github.io/react-meal-swipe/#/</Link>, you are agreeing to be
    ...
    <Typography variant="body1" gutterBottom>
      ...
      (information or software) on MealSwipe website for personal,
    ...
    <Typography component="div" variant="body1" gutterBottom>
      <ul>
        ...
        <li>
          attempt to decompile or reverse engineer any software contained on MealSwipe's website;
        </li>
        <li>
    ...
    <Typography variant="body1" gutterBottom>
      ...
      restrictions and may be terminated by MealSwipe at any time. Upon
    ...
    <Typography variant="body1" gutterBottom>
      The materials on MealSwipe's website are provided on an 'as is'
      basis. MealSwipe makes no warranties, expressed or implied, and
    ...
    <Typography variant="body1" gutterBottom>
      Further, MealSwipe does not warrant or make any representations
    ...
    <Typography variant="body1" gutterBottom>
      In no event shall MealSwipe or its suppliers be liable for any
      damages (including, without limitation, damages for loss of data or
      profit, or due to business interruption) arising out of the use or
      inability to use the materials on MealSwipe's website, even if MealSwipe or a MealSwipe
    ...
    <Typography variant="body1" gutterBottom>
      The materials appearing on MealSwipe's website could include
      technical, typographical, or photographic errors. MealSwipe does
      not warrant that any of the materials on its website are accurate,
      complete or current. MealSwipe may make changes to the materials
      contained on its website at any time without notice. However MealSwipe
      does not make any commitment to update the materials.
    </Typography>

    <Typography variant="h6">6. Links</Typography>
    <Typography variant="body1" gutterBottom>
      MealSwipe has not reviewed all of the sites linked to its website
      and is not responsible for the contents of any such linked site. The
      inclusion of any link does not imply endorsement by MealSwipe of
      the site. Use of any such linked website is at the user's own risk.
    </Typography>

    <Typography variant="h6">7. Modifications</Typography>
    <Typography variant="body1" gutterBottom>
      MealSwipe may revise these terms of service for its website at any
...
const PrivacyPolicy = () => (
  <>
    ...
    <Typography variant="body1" gutterBottom>
      Your privacy is important to us. It is MealSwipe's policy to respect
      your privacy regarding any information we may collect from you across our
      website, <Link href="/">https://jratana1.github.io/react-meal-swipe/#/</Link>, and other
